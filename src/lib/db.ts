...
function seed(db: Low<DbShape>) {
  const draws: Draw[] = [
    { id: "d1", name: "Balochistan Prize Bond Draw #45", drawDate: "2026-09-15", ticketPrice: 750, active: true },
    { id: "d2", name: "Balochistan Prize Bond Draw #46", drawDate: "2026-10-15", ticketPrice: 750, active: true },
